...
press(val) {
  console.log(val);
  console.log('inside img',this.props.store.getState())
  console.log(this.props.Actions)
  console.log(this.props.Actions.selectActivity(val));
  this.props.store.dispatch(this.props.Actions.selectActivity(val))
}
endReached(){
  console.log('hit end')
  ...
  render(){
    console.log("CURRENT STORE", this.props.store.getState())
    return(
      <View style={{flex:1}}>
